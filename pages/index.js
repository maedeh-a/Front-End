      ...
      <div className="bg-[#005BEA]">
        <div className="container text-white mx-auto flex flex-col lg:flex-row items-stretch justify-between py-14 gap-14 px-5 lg:px-9">
          <div className="w-full lg:w-1/2">
            ...
            صاب‌ملک پلتفرم تامین مالی جمعی و بدون وقفه پروژه‌های ملکی و ساخت‌وساز با مدیریت سودآور برای سرمایه‌گذاران است. سرمایه‌گذاری در ساخت و ساز از پرسودترین فعالیت‌های اقتصادی در کشور است. اما ورود به این حوزه نیازمند تخصص، سرمایه زیاد و صرف وقت و انرژی قابل‌توجه است.تیم صاب‌ملک با تحقیقات فراوان و مطالعه‌ی تجربیات سازندگان مختلف، تعاونی‌های مسکن، شرکت‌های سرمایه‌گذاری مسکن و سرمایه گذاران حقیقی، مدل منحصربه‌فردی را طراحی کرده‌ که با تجمیع سرمایه‌های افراد مختلف (تامین مالی جمعی) و صرفه‌جویی در زمان و هزینه سرمایــه‌گذاران، به مدیریت پروژه‌ها می‌پردازد.
            </p>
          </div>
