        ...
        <div className="container text-white mx-auto flex flex-col lg:flex-row items-stretch justify-between py-14 gap-14 px-5 lg:px-9">
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-justify lg:leading-10 leading-7">
              ...
              از پرسودترین فعالیت های اقتصادی در کشور است. تیم صاب‌ملک با تحقیقات فراوان و مطالعه تجربیات سازنگان مختلف، تعاونی های مسکن و سرمایه‌گذاران حقیقی، مدل منحصر بفردی را طراحی
              کرده که با تجمیع سرمایه افراد مختلف(تامین مالی جمعی) 
              و صرفه جویی در زمان و هزینه سرمایه‌گذاران، به مدیریت پروژه ها می‌‍پردازد.
            </p>
          </div>
